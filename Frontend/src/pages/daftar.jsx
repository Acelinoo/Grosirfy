...
const DaftarPage = () => {
  return (
    <div className="flex h-screen ">
      {/* Bagian Kiri */}
      <div className="w-1/2 bg-[#ECF0F1] flex flex-col justify-center items-center">
        <div className="flex flex-col ">
          <h1 className="text-7xl font-bold text-gray-800 mb-3">Grosirfy</h1>
          <h3 className="text-3xl font-bold text-[#2C3E50]">
            Harga Teman, Cepat Sampai!
          </h3>
        </div>
        <div className="mt-8">
          <img src="/assets/vector.svg" alt="Vector" className="w-68 h-auto" />
        </div>
      </div>
      {/* Kanan */}
      <div className="w-1/2 flex flex-col justify-center items-center bg-[#2C3E50]">
        <div className="w-2/3 bg-white rounded-[20px] ">
          <div className="flex flex-col justify-between ml-11">
            <h1 className="text-2xl font-bold text-[#1F1F1F] mt-9 ">
              Grosirfy
            </h1>
          ...
          <button className=" ml-[45px] w-[480px] py-2 border border-gray-300 flex justify-center items-center rounded-[5px] hover:bg-gray-100 transition duration-300">
            <img
